...
public:
   ...
   {
      std::string citations = "Britannica, Gustavus J. Simmons, Vigenere Cipher - https://www.britannica.com/topic/Vigenere-cipher\n";
      citations += "GeeksforGeeks, Vigenere Cipher - https://www.geeksforgeeks.org/vigenere-cipher/\n";
